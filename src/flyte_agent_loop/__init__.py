...
* :mod:`flyte_agent_loop.pipeline_builder` — every 5 minutes: claim an open
...
* :mod:`flyte_agent_loop.pipeline_reviewer` — every 5 minutes: claim an open
  agent-authored PR, address its review comments, verify the fixes, push them,
  and release the claim.
* :mod:`flyte_agent_loop.pipeline_distiller` — every 10 minutes: compact the run
